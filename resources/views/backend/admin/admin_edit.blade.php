...
<input type="hidden" name="id" value="{{ $admin->id }}">
        <div class="row">
            <div class="form-group col-md-6 mb-3">
                ...
                <input value="{{ $admin->username }}" type="text" name="username" class="form-control" id="inputEmail4" >
            </div>

             <div class="form-group col-md-6 mb-3">
                <label for="inputEmail4" class="form-label"> Name </label>
                <input value="{{ $admin->name }}" type="text" name="name" class="form-control" id="inputEmail4" >
            </div>


             <div class="form-group col-md-6 mb-3">
                <label for="inputEmail4" class="form-label">Email </label>
                <input value="{{ $admin->email }}" type="email" name="email" class="form-control" id="inputEmail4" >
            </div>

             <div class="form-group col-md-6 mb-3">
                <label for="inputEmail4" class="form-label">Phone </label>
                <input value="{{ $admin->phone }}" type="text" name="phone" class="form-control" id="inputEmail4" >
            </div>
