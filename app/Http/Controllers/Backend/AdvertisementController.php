...

{
    public function home_ad_show()
    {
        ...
        return view('backend.advertisements.advertisement_home_view',compact('home_ad_data'));
    }
    ...
    public function home_ad_update(Request $request)
    {
        ...
        if($request->hasFile('above_search_ad')) {
            ...
            unlink(public_path('upload/advertisements/'.$home_ad_data->above_search_ad));

            $ext = $request->file('above_search_ad')->extension();
            $final_name = 'above_search_ad'.'.'.$ext;
            $request->file('above_search_ad')->move(public_path('upload/advertisements/'),$final_name);
        ...
        if($request->hasFile('above_footer_ad')) {
            ...
            unlink(public_path('upload/advertisements/'.$home_ad_data->above_footer_ad));

            $ext = $request->file('above_footer_ad')->extension();
            $final_name = 'above_footer_ad'.'.'.$ext;
            $request->file('above_footer_ad')->move(public_path('upload/advertisements/'),$final_name);
    ...
    public function top_ad_show()
    {
        ...
        return view('backend.advertisements.advertisement_top_view',compact('top_ad_data'));
    }
    ...
    public function sidebar_ad_show()
    {
        ...
        return view('backend.advertisements.advertisement_sidebar_view',compact('sidebar_ad_data'));
    }

    public function sidebar_ad_create()
    {
        return view('backend.advertisements.advertisement_sidebar_create');
    }
    ...
    public function sidebar_ad_store(Request $request)
    {
        ...
        $request->file('sidebar_ad')->move(public_path('upload/advertisements/'),$final_name);
    ...
    public function sidebar_ad_edit($id)
    {
        ...
        return view('backend.advertisements.advertisement_sidebar_edit', compact('sidebar_ad_data'));
    }
