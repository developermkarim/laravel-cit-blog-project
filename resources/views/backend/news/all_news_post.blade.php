...
@section('admin') 
 ...
 <div class="content">
     ...
     <span class="badge badge-pill bg-danger">InActive</span>
      ...
      @if($item->status == 1)
 <a href="{{ route('inactive.news.post',$item->id) }}" class="btn btn-primary rounded-pill waves-effect waves-light" title="Inactive">{{-- <i class="fa-solid fa-thumbs-down"></i> --}} Inactive</a>
      @else
 <a href="{{ route('active.news.post',$item->id) }}" class="btn btn-primary rounded-pill waves-effect waves-light" title="Active">{{-- <i class="fa-solid fa-thumbs-up"></i> --}} active </a>
      @endif 
