...
## Dependencies/The Technology installed by CLI php artisan (required Name)
...
- `stichoza/google-translate-php`: `^5.1`
 ...
 ## JS Plugin To Make User Friendly
  - index.js
  - jquery-3.5.1.min.js
  - bootstrap.min.js
...
This applications uses Laravel JetStream Packege to handle authentication.
