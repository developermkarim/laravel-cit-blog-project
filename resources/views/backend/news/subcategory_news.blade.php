...
@section('home')
@section('title', $bread_subcategory->subcategory_name)
<div class="container">
    <div class="row">
        <div class="col-lg-12">
    ...
    <div class="row">
        <div class="col-lg-8 col-md-8">
            <div class="rachive-info-cats">
                <a href=" "><i class="las la-home"></i> </a> <i
                    class="las la-chevron-right"></i>{{ $bread_subcategory->subcategory_name }}
            </div>
                            ...
                            <div class="archive-shadow arch_margin">
                                ...
                                <div class="archive1-padding">
                                    <div class="archive1-title"><a
                                            href="{{ url('news/post/details/' . $item->id . '/' . $item->news_title_slug) }}">{{ $item->news_title }}</a>
                                    </div>
                                    <div class="content-details"> <a
                                            href="{{ url('news/post/details/' . $item->id . '/' . $item->news_title_slug) }}"> Read
                                            More </a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="archive-item-wrpp2">
                                        <div class="archive-shadow arch_margin">
                                            <div class="archive1_image2">
                                                <a
                                                    href="{{ url('news/post/details/' . $item->id . '/' . $item->news_title_slug) }}"><img
                                                        class="lazyload" src="{{ asset($item->image) }}"></a>
                                                <div class="archive1-meta">
                                                    <a href=" "><i class="la la-tags"> </i>
                                                        {{ $item->created_at->format('l M d Y') }}
        ...
        <div class="col-lg-4 col-md-4">
            <div class="sitebar-fixd" style="position: sticky; top: 0;">
             ...
             <div class="tab-pane fade active show" id="archiveTab_recent" role="tabpanel"
                ...
                <div class="archiveTab-sibearNews">
                    ...
                    @foreach ($latest_posts as $key => $newsitem)
         ...
         <div class="tab-pane fade" id="archiveTab_popular" role="tabpanel"
                ...
                <div class="archiveTab-sibearNews">
                    @foreach ($popular_posts as $key => $newsitem)
                        <div class="archive-tabWrpp archiveTab-border">
                            <div class="archiveTab-image ">
                                <a
