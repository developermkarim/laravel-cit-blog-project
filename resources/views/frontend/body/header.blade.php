...
<li id="menu-item-291" class="menu-item-object-category menu-item-has-children menu-item-291 {{ count($category->subcategory) >= 1 ? ' has-sub ':'' }} ">
